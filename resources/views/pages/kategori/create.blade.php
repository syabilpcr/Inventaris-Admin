...
<div class="container-fluid py-4 px-4 main-wrapper animate__animated animate__fadeIn" style="background: #f9f3ef; min-height: 100vh;">
    ...
    <div class="card-custom shadow-lg border-0 rounded-4 animate__animated animate__fadeInUp">
        <form method="POST" action="{{ route('kategori.store') }}" id="kategoriForm">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="nama_kategori" class="form-label fw-semibold" style="color: #1b3c53;">Nama Kategori <span class="text-danger">*</span></label>
                    <input type="text" 
                           class="form-control" 
                           id="nama_kategori" 
                           name="nama_kategori"
                ...
                <div class="col-md-6">
                    <label for="kode_kategori" class="form-label fw-semibold" style="color: #1b3c53;">Kode Kategori <span class="text-danger">*</span></label>
                    <input type="text" 
                           class="form-control" 
                           id="kode_kategori" 
                           name="kode_kategori"
                ...
                <div class="d-flex gap-4 flex-wrap">
                    <div class="form-check">
                        <input class="form-check-input" 
                               ...
                               style="border-color: #456882;">
                        <label class="form-check-label fw-semibold" for="status_aktif" style="color: #456882;">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" 
                               ...
                               style="border-color: #1b3c53;">
                        <label class="form-check-label fw-semibold" for="status_nonaktif" style="color: #1b3c53;">
